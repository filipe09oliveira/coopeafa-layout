...
<form class="needs-validation" action="/propriedades" method="POST" novalidate>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="number" class="form-control form-control-sm" name="tamanho" id="tamanho" placeholder="Tamanho"
                required>
            <div class="invalid-feedback">
                Por favor, escolha um nome para propriedade.
            </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control form-control-sm" name="numero" id="numero" placeholder="Numero"
                required>
            <div class="invalid-feedback">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-sm" name="contrato" id="contrato" placeholder="contrato"
                required>
            <div class="invalid-feedback">
